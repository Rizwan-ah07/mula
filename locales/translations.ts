...
export const translations = {
  ...
  table: {
    ...
    addressLabel: { nl: 'Adres', en: 'Address', fr: 'Adresse' },
    addressPlaceholder: { nl: 'Straat + nummer, postcode, stad', en: 'Street + number, postal code, city', fr: 'Rue + numero, code postal, ville' },
    cashOnly: { nl: 'Alleen contant betalen.', en: 'Cash only.', fr: 'Paiement en especes uniquement.' },
    deliveryInfo: { nl: 'Gratis levering binnen 15 km vanaf Statieslei 25. Minimum €15.', en: 'Free delivery within 15 km from Statieslei 25. Minimum €15.', fr: 'Livraison gratuite dans un rayon de 15 km de Statieslei 25. Minimum 15€.' },
